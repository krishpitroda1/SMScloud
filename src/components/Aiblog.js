  ...
  return (
    <div>
      <div className=" w-screen aib relative p-10">
        ...
        <p className="p-4 pb-0 text-xl font-bold font-sans">– Security</p>
        <p className="p-4 ml-4 pb-0 text-xl font-sans">
        ...
        <p className="p-4 pb-0  ml-4 font-bold text-xl font-sans">
        ...
        <p className="p-4 pb-0 text-xl font-bold font-sans">– Privacy</p>
        <p className="p-4 pb-0 ml-4 text-xl font-sans">
          There should be enough arrangement not to track user and the AI data
          has to be kept safe as per GDPR laws
        </p>
        <p className="p-4 pb-0 text-xl font-bold font-sans">– Scalability</p>
        <p className="p-4 pb-0 text-xl ml-4 font-sans">
          Another major point to be considered for the higher number of
          interaction
        </p>
        <p className="p-4 pb-0 text-xl font-bold font-sans">– Dashboard</p>
        <p className="p-4 pb-0 ml-4 text-xl font-sans">
