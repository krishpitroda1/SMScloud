  ...
  return (
    <div>
      <div className="lg:w-[50%] md:w-[70%]  lg:top-[30%] mr-10 lg:left-[30%]  z-10 absolute border border-black">
        <h1 className=" text-white  text-center p-5 text-lg lg:text-2xl font-bold divs border-b ">
          Voice-Voip
          <span
            id="close"
         ...
         <RevealOnScroll>
          <div className="flex flex-col justify-center">
            <p className="text-sky-600  p-5 font-bold text-2xl">
              Voice-Voip  with SMSCloud Hub
            </p>
            <div className="flex p-5 pt-0  gap-3 ">
              <div className="">
                <div className="flex">
                  <h1 className="align-center text-gray-500  text-xl">
                 Use of internet to send out voice call globally using SIP protocol and ...
                  </h1>
                </div>
              </div>
            </div>
