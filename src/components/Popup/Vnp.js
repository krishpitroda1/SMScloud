...
import img1 from "C:/Users/krish/OneDrive/Desktop/sms3/smsloud/src/assets/vn.jpg";
              ...
              <div className="">
                <div className="flex">
                  ...
                  <h1 className="align-center text-sky-600 font-serif text-xl">
                    You can also get an international toll-free number in 120+
                    countries with advanced call management features .
                  </h1>
                </div>
              </div>
            </div>
