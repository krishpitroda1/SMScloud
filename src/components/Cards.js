    ...
    <div className="w-full py-[10rem] justify-center overflow-hidden">
      ...
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8 ">
        <div className="w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 hover:bg-sky-600 duration-300 bg-slate-400">
          <img
            src={single}
            className="w-20 mx-auto mt-[-3rem] bg-white rounded-full  h-20"
            alt="/"
          />
        ...
        <div className="w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105  bg-slate-400 hover:bg-sky-600 duration-300">
          <img
            src={single}
            className="w-20 mx-auto mt-[-3rem] bg-white rounded-full h-20"
            alt="/"
