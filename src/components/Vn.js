            ...
            <div className="flex flex-col justify-center text-center mx-auto ">
              <RevealOnScroll>
                <p className="font-bold lg:text-4xl text-3xl text-center  text-sky-600 ">
                  Have your own virtual phone number <br />{" "}
                  <span className="text-gray-400">
                    {" "}
                    in any city or country worldwide{" "}
                  </span>
                </p>
                <p className="text-center p-5 lg:p-36 lg:pt-2 lg:pb-0 text-gray-400 lg:text-2xl text-2xl ">
                  A Virtual number is Showing a local number to visitors at your
                  web site increases trust and sales with SMSCloud Hub
                </p>
              </RevealOnScroll>
            </div>
          </div>
          ...
          <div className="grid   lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-3  p-5 lg:pr-8">
            <div className="benefits rounded-lg   p-5 bg-sky-900 hover:bg-gray-400  text-white">
              <RevealOnScroll>
                ...
                <p>
                  Track every inbound and outbound call that engage proactively
            ...
            <div className="benefits rounded-lg   p-5 bg-sky-900 hover:bg-gray-400 text-white">
              <RevealOnScroll>
                ...
                <p>
                  A Virtual Number is the solution that allows you to mask
                  numbers of both the agent and a customer
                </p>
              </RevealOnScroll>
            </div>
            <div className="benefits rounded-lg  -32  p-5 bg-sky-900 hover:bg-gray-400 text-white">
              <RevealOnScroll>
                ...
                <p>
                  Forward all the customer calls to agents to manage business
                  call from anywhere
                </p>
              </RevealOnScroll>
            </div>
            <div className="benefits rounded-lg    p-5 bg-sky-900 hover:bg-gray-400 text-white">
              <RevealOnScroll>
                ...
                <p>
                  Route the customer calls to specific agents based on their
                  availability
                </p>
              </RevealOnScroll>
            </div>
            ...
            <div className=" benefits rounded-lg  p-5  bg-sky-900 hover:bg-gray-400 text-white">
              <RevealOnScroll>
                ...
                <p>
                  Ensure customer privacyGuarantee customer confidentiality and
                  prevent any lead exposure with a number masking solution
                </p>
              </RevealOnScroll>
            </div>
          </div>
