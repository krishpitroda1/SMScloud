  ...
  <div className="lg:grid lg:grid-cols-12 lg:items-center lg:justify-between">
    <div className="lg:col-span-5 lg:col-start-1">
      ...
      <blockquote className="relative">
        <svg className="absolute ml-8 mt-5 top-0 start-0 transform -translate-x-6 -translate-y-8 h-10 w-10 text-gray-200 dark:text-gray-800"  viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <div className="relative pt-0 z-10 p-5">
          <p className="text-2xl text-sky-600">
            Amazing people to work with. Very fast and professional partner.
          </p>
        </div>

        <footer className="pl-7">
      ...
      <div className="space-y-6 sm:space-y-8">
        <ul className="grid grid-cols-2 divide-y divide-y-2 divide-x divide-x-2 divide-gray-200 overflow-hidden dark:divide-gray-700">
          <li className="flex flex-col -m-0.5 p-4 sm:p-8">
            <div className="flex p-2 pl-5 text-3xl sm:text-5xl font-bold">
              45k+
            </div>
          ...
          <li className="flex flex-col -m-0.5 p-4 sm:p-8">
            <div className="flex p-2 text-3xl sm:text-5xl font-bold">
      ...
      <div className="flex p-3">
        ...
        "Choosing SMSCloud Hub as our aggregator was the best decision we made for our business. Their platform seamlessly connects us with multiple telecom operators, simplifying our messaging operations and enabling us to reach our customers more effectively."
          ...
          <div className="p-4 bg-gray-100 rounded-b-xl md:px-7 dark:bg-slate-700">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <img className="h-8 w-8 rounded-full sm:h-[2.875rem] sm:w-[2.875rem]" src="https://th.bing.com/th/id/OIP.ROJLMWQcPybcPj5Pn70_oAHaHa?rs=1&pid=ImgDetMain" alt="Image Description"/>
              </div>
